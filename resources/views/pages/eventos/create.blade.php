        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex-row-fluid">
                    <!--begin::Form-->
                    <form class="form w-lg mx-auto" novalidate="novalidate" id="kt_stepper_example_basic_form">
                        <!--begin::Group-->
                        <div class="mb-5">
                            <!--begin::Step 1-->
                            <div class="flex-column current" data-kt-stepper-element="content">
                                ...
                                <div class="fv-row mb-5">
                                    <!--begin::Option-->
                                    <input type="radio" class="btn-check" name="tipo" value="Atividade" id="kt_radio_buttons_2_option_2"/>
                                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center" for="kt_radio_buttons_2_option_2">
                                        <i class="bi bi-kanban fs-3x me-4"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                        <span class="d-block fw-semibold text-start">
                                            <span class="text-dark fw-bold d-block fs-6">Atividade</span>
                                            <span class="text-muted fw-semibold fs-6"><small> will send a code via SMS if you need to use your backup login method.</small></span>
                                        </span>
                                    </label>
                                    <!--end::Option-->
                                </div>
