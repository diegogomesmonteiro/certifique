...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{ __('Detalhes do perfil') }}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('settings.update') }}"
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('Nome Completo') }}</label>
                    <!--end::Label-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('CPF') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" id="cpf" name="cpf"
                            class="form-control form-control-lg form-control-solid" placeholder="000.000.000-00"
                            maxlength="14" onkeypress="formatarCpf()" value="{{ old('cpf', $info->cpf ?? '') }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid"
                            placeholder="Telefone" value="{{ old('phone', $info->phone ?? '') }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{ __('Endereço') }}</span>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <textarea name="endereco" class="form-control form-control-lg form-control-solid" placeholder="Endereço"
                            value="{{ old('endereco', $info->endereco ?? '') }}">{{ $info->endereco ?? '' }}</textarea>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                        <span class="required">{{ __('Cidade/UF') }}</span>
                    </label>
                    <!--end::Label-->
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="cidade" class="form-control form-control-lg form-control-solid"
                            placeholder="cidade" value="{{ old('cidade', $info->cidade ?? '') }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
